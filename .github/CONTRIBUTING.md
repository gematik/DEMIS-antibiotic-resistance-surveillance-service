...
Please do not report vulnerabilities and security incidents as GitHub issues. Please contact us by sending an E-Mail to [Open Source Program Office](mailto:ospo@gematik.de?subject=[GitHub]%20Antibiotic-Resistance-Surveillance-Service) or report them using the contact form at https://fachportal.gematik.de/kontaktformular.
